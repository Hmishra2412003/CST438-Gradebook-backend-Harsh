...
public class Assignment {
	...
	// Constructor to ensure dueDate is not null when creating an Assignment
	public Assignment() {
		this.dueDate = new Date(System.currentTimeMillis()); // Initialize with the current date

		this.course = new Course(); // Initialize with a new Course instance
	}
}
